package fr.inria.diverse.ad.impl.operation.executable.activityedge;
...
import fr.inria.diverse.ad.visitor.OfferVisitor;
...
public abstract class ActivityEdgeActivityEdgeOperationImpl implements ActivityEdgeOperation {
	...
	private final OfferVisitor offerVisitor = new OfferVisitor();
