...
public class ExpressionExecutionVisitor extends ActivityDiagramVisitorDefault<Void> {
	...
	@Override
	public Void visitIntegerCalculationExpression(final IntegerCalculationExpression integerCalculationExpression) {
	...
	@Override
	public Void visitIntegerComparisonExpression(final IntegerComparisonExpression integerComparisonExpression) {
	...
	@Override
	public Void visitBooleanBinaryExpression(final BooleanBinaryExpression booleanBinaryExpression) {
	...
	@Override
	public Void visitBooleanUnaryExpression(BooleanUnaryExpression booleanUnaryExpression) {
